var userStoreShopee = new function () {
    ...
    vm.initialize = function (inJsResx) {
        ...
        if (userTaskId != null) {
            if (demo != null && demo == "true") {
                demo = true;
                loadDemoStoreShopeeTaskDetails();
            } else {
                loadStoreShoppeTaskDetails();
            }
        } else {
    ...
    function loadDemoStoreShopeeTaskDetails() {
        ...
        $.ajax({
            ...
            .done(function (response) {
                ...
                setStoreShopeeTaskDetails(response.data);
            })
    ...
    function loadStoreShoppeTaskDetails() {
        window.Global.ShowLoadingSpinner();
    ...
    function setStoreShopeeTaskDetails(responseData) {
    ...
    vm.buyNowClick = function () {
        if (demo == true) {
            ...
            Swal.fire({
                ...
                showConfirmButton: true,
                showCancelButton: true,
                confirmButtonText: jsResx.buyNow
            }).then((result) => {
